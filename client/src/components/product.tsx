	...
	return (
		<div className="group bg-white rounded-lg overflow-hidden border border-gray-150 hover:shadow-lg transition-all duration-300">
			...
			<div className="relative overflow-hidden">
				...
				<button className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-white text-red-600 px-4 py-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 shadow-md hover:bg-red-600 hover:text-white">
