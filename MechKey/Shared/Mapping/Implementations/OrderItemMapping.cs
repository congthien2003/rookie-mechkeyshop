...
namespace Shared.Mapping.Implementations
{
    ...
    {
        public OrderItemModel ToOrderItemModel(OrderItem item)
        {
        ...
        public List<OrderItemModel> ToListOrderItemModel(List<OrderItem> items)
        {
        ...
        public OrderItem ToOrderItem(OrderItemModel model)
        {
        ...
        public List<OrderItem> ToListOrderItem(List<OrderItemModel> models)
        {
        ...
        public OrderItem ToOrderItemFromCreatedOrderItemModel(CreateOrderItemViewModel model)
        {
            return new OrderItem
            {
                Id = Guid.NewGuid(),
