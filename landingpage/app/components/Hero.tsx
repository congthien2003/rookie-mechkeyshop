    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          <span className="text-white font-semibold">React</span>, Event Sourcing,
          RabbitMQ, Redis, and YARP — designed for scale and observability.
        </p>
        ...
        <div className="mt-16 rounded-2xl overflow-hidden border border-white/10 shadow-2xl shadow-indigo-900/40 relative w-full aspect-video">
          <Image
            src="https://bsnnwuphmgsqfpvlqdwn.supabase.co/storage/v1/object/public/assets//MechKeyShop-Architecture.png"
